...
(function () {
  ...
  document.querySelectorAll("div[laratables-wrapper='yes']").forEach(function (wrapperElement) {
    var checkboxName = wrapperElement.getAttribute('laratables-checkbox-name');
    ...
    wrapperElement.querySelectorAll("input[laratables-id='checkbox-parent']").forEach(function (parentCheckbox) {
      parentCheckbox.addEventListener('click', function (event) {
        ...
        wrapperElement.querySelectorAll("input[laratables-id='checkbox-parent']").forEach(function (mainCheckbox) {
